...
window.Learning = (() => {
  ...
  function viewedRecords() { try { return store?.state().viewed || {}; } catch (e) { error = e.message; return {}; } }
  function openViewed() {
    open();
  ...
  return { init, open, openViewed, favorites, viewed, viewedIds, viewedRecords, toggleFavorite, beginQuiz, answerQuiz, finishQuiz: quizRecord, sync, connect, disconnect, importGuest, backup, restore, get ready() { return ready; } };
})();
